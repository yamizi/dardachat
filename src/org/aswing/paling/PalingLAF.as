package org.aswing.paling
{
	...
	public class PalingLAF extends BasicLookAndFeel
	{
		...
		override protected function initSystemColorDefaults(table:UIDefaults):void{
			...
			var defaultSystemColors:Array = [
				...
				"text", 0xcccccc, /* Text background color */
				"textText", 0x333333, /* Text foreground color */
				...
				"selectionBackground", 0xcccccc, //0x316AC5, 
				"selectionForeground", 0x333333, 
			...
			table.put("focusInner", new ASColorUIResource(0xCCCCCC, 0.2));
			table.put("focusOutter", new ASColorUIResource(0xCCCCCC, 0.4));
		}
		...
		//======================================================================
		[Embed(source="assets/Button_defaultImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var Button_defaultImage:Class;
		
		[Embed(source="assets/Button_pressedImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var Button_pressedImage:Class;
		
		[Embed(source="assets/Button_rolloverImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var Button_rolloverImage:Class;
		
		[Embed(source="assets/Button_disabledImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="13")]
		private var Button_disabledImage:Class;
		
		[Embed(source="assets/Button_DefaultButton_defaultImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		...
		//============================================================================
		[Embed(source="assets/ToggleButton_defaultImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var ToggleButton_defaultImage:Class;
		
		[Embed(source="assets/ToggleButton_pressedImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var ToggleButton_pressedImage:Class;
		
		[Embed(source="assets/ToggleButton_disabledImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="11")]
		private var ToggleButton_disabledImage:Class;
		
		[Embed(source="assets/ToggleButton_selectedImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var ToggleButton_selectedImage:Class;
		
		[Embed(source="assets/ToggleButton_disabledSelectedImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var ToggleButton_disabledSelectedImage:Class;
		
		[Embed(source="assets/ToggleButton_rolloverImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		private var ToggleButton_rolloverImage:Class;
		
		[Embed(source="assets/ToggleButton_rolloverSelectedImage.png", scaleGridTop="6", scaleGridBottom="14", scaleGridLeft="6", scaleGridRight="14")]
		...
		[Embed(source="assets/ScrollBar_verticalBGImage.png", scaleGridTop="17", scaleGridBottom="28", scaleGridLeft="3", scaleGridRight="12")]
		private var ScrollBar_verticalBGImage:Class;
		
		[Embed(source="assets/ScrollBar_horizotalBGImage.png", scaleGridTop="3", scaleGridBottom="12", scaleGridLeft="17", scaleGridRight="28")]
		...
		//vertical
		[Embed(source="assets/ScrollBar_thumbVertical_defaultImage.png", scaleGridTop="3", scaleGridBottom="7", scaleGridLeft="2", scaleGridRight="11")]
		private var ScrollBar_thumbVertical_defaultImage:Class;
		
		[Embed(source="assets/ScrollBar_thumbVertical_pressedImage.png", scaleGridTop="3", scaleGridBottom="7", scaleGridLeft="2", scaleGridRight="11")]
		private var ScrollBar_thumbVertical_pressedImage:Class;
		
		[Embed(source="assets/ScrollBar_thumbVertical_rolloverImage.png", scaleGridTop="3", scaleGridBottom="7", scaleGridLeft="2", scaleGridRight="11")]
		private var ScrollBar_thumbVertical_rolloverImage:Class;
		
		[Embed(source="assets/ScrollBar_thumbVertical_disabledImage.png", scaleGridTop="3", scaleGridBottom="7", scaleGridLeft="2", scaleGridRight="11")]
		...
		//horizontal
		[Embed(source="assets/ScrollBar_thumbHorizontal_defaultImage.png", scaleGridTop="2", scaleGridBottom="11", scaleGridLeft="3", scaleGridRight="7")]
		private var ScrollBar_thumbHorizontal_defaultImage:Class;
		
		[Embed(source="assets/ScrollBar_thumbHorizontal_pressedImage.png", scaleGridTop="2", scaleGridBottom="11", scaleGridLeft="3", scaleGridRight="7")]
		private var ScrollBar_thumbHorizontal_pressedImage:Class;
		
		[Embed(source="assets/ScrollBar_thumbHorizontal_rolloverImage.png", scaleGridTop="2", scaleGridBottom="11", scaleGridLeft="3", scaleGridRight="7")]
		private var ScrollBar_thumbHorizontal_rolloverImage:Class;
		
		[Embed(source="assets/ScrollBar_thumbHorizontal_disabledImage.png", scaleGridTop="2", scaleGridBottom="11", scaleGridLeft="3", scaleGridRight="7")]
		...
		//=====================================================================
		[Embed(source="assets/TextField_defaultImage.png", scaleGridTop="6", scaleGridBottom="16", scaleGridLeft="6", scaleGridRight="16")]
		private var TextField_defaultImage:Class;
		
		[Embed(source="assets/TextField_uneditableImage.png", scaleGridTop="6", scaleGridBottom="16", scaleGridLeft="6", scaleGridRight="16")]
		private var TextField_uneditableImage:Class;
		
		[Embed(source="assets/TextField_disabledImage.png", scaleGridTop="6", scaleGridBottom="16", scaleGridLeft="6", scaleGridRight="13")]
		...
		//========================================================================
		[Embed(source="assets/TextArea_defaultImage.png", scaleGridTop="6", scaleGridBottom="16", scaleGridLeft="6", scaleGridRight="16")]
		private var TextArea_defaultImage:Class;
		
		[Embed(source="assets/TextArea_uneditableImage.png", scaleGridTop="6", scaleGridBottom="16", scaleGridLeft="6", scaleGridRight="16")]
		private var TextArea_uneditableImage:Class;
		
		[Embed(source="assets/TextArea_disabledImage.png", scaleGridTop="6", scaleGridBottom="16", scaleGridLeft="6", scaleGridRight="13")]
		...
		[Embed(source="assets/Frame_activeBG.png",  scaleGridTop="42", scaleGridBottom="138", scaleGridLeft="11", scaleGridRight="118")]
		private var Frame_activeBG:Class;
		
		[Embed(source="assets/Frame_inactiveBG.png",  scaleGridTop="42", scaleGridBottom="138", scaleGridLeft="11", scaleGridRight="118")]
		private var Frame_inactiveBG:Class;
		
		//========= Frame_Icon Images =======
		[Embed(source="assets/Frame_icon.png")]
		private var Frame_Icon_defaultImage:Class;
		...
		//======================================================================
		[Embed(source="assets/ToolTip_bgImage.png", scaleGridTop="4", scaleGridBottom="5", scaleGridLeft="7", scaleGridRight="16")]
		...
		//========= Background Images =======
		[Embed(source="assets/ComboBox_defaultRolloverImage.png", scaleGridTop="6", scaleGridBottom="8", scaleGridLeft="3", scaleGridRight="68")]
		private var ComboBox_defaultRolloverImage:Class;
		[Embed(source="assets/ComboBox_defaultImage.png", scaleGridTop="6", scaleGridBottom="8", scaleGridLeft="3", scaleGridRight="68")]
		private var ComboBox_defaultImage:Class;
		
		[Embed(source="assets/ComboBox_uneditableImage.png", scaleGridTop="6", scaleGridBottom="8", scaleGridLeft="3", scaleGridRight="68")]
		...
		[Embed(source="assets/ComboBox_disabledImage.png", scaleGridTop="6", scaleGridBottom="8", scaleGridLeft="3", scaleGridRight="68")]
		...
		//======================================================================
		[Embed(source="assets/Accordion_header_defaultImage.png", scaleGridTop="3", scaleGridBottom="19", scaleGridLeft="3", scaleGridRight="74")]
		private var Accordion_header_defaultImage:Class;
		
		[Embed(source="assets/Accordion_header_pressedImage.png", scaleGridTop="3", scaleGridBottom="19", scaleGridLeft="3", scaleGridRight="74")]
		private var Accordion_header_pressedImage:Class;
		
		[Embed(source="assets/Accordion_header_rolloverImage.png", scaleGridTop="3", scaleGridBottom="19", scaleGridLeft="3", scaleGridRight="74")]
		private var Accordion_header_rolloverImage:Class;
		
		[Embed(source="assets/Accordion_header_disabledImage.png", scaleGridTop="3", scaleGridBottom="19", scaleGridLeft="3", scaleGridRight="74")]
		private var Accordion_header_disabledImage:Class;
		
		[Embed(source="assets/Accordion_header_selectedImage.png", scaleGridTop="3", scaleGridBottom="19", scaleGridLeft="3", scaleGridRight="74")]
		...
		//======================================================================
		//========= header top scale-9 =======
		[Embed(source="assets/TabbedPane_top_tab_defaultImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_top_tab_defaultImage:Class;
		
		[Embed(source="assets/TabbedPane_top_tab_pressedImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_top_tab_pressedImage:Class;
		
		[Embed(source="assets/TabbedPane_top_tab_rolloverImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_top_tab_rolloverImage:Class;
		
		[Embed(source="assets/TabbedPane_top_tab_disabledImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_top_tab_disabledImage:Class;
		
		[Embed(source="assets/TabbedPane_top_tab_selectedImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_top_tab_selectedImage:Class;
		
		[Embed(source="assets/TabbedPane_top_tab_rolloverSelectedImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_top_tab_rolloverSelectedImage:Class;
		
		//========= header bottom scale-9 =======
		[Embed(source="assets/TabbedPane_bottom_tab_defaultImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_bottom_tab_defaultImage:Class;
		
		[Embed(source="assets/TabbedPane_bottom_tab_pressedImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_bottom_tab_pressedImage:Class;
		
		[Embed(source="assets/TabbedPane_bottom_tab_rolloverImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_bottom_tab_rolloverImage:Class;
		
		[Embed(source="assets/TabbedPane_bottom_tab_disabledImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_bottom_tab_disabledImage:Class;
		
		[Embed(source="assets/TabbedPane_bottom_tab_selectedImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_bottom_tab_selectedImage:Class;
		
		[Embed(source="assets/TabbedPane_bottom_tab_rolloverSelectedImage.png", scaleGridTop="5", scaleGridBottom="18", scaleGridLeft="5", scaleGridRight="12")]
		private var TabbedPane_bottom_tab_rolloverSelectedImage:Class;
		
		//========= header left scale-9 =======
		[Embed(source="assets/TabbedPane_left_tab_defaultImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_left_tab_defaultImage:Class;
		
		[Embed(source="assets/TabbedPane_left_tab_pressedImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_left_tab_pressedImage:Class;
		
		[Embed(source="assets/TabbedPane_left_tab_rolloverImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_left_tab_rolloverImage:Class;
		
		[Embed(source="assets/TabbedPane_left_tab_disabledImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_left_tab_disabledImage:Class;
		
		[Embed(source="assets/TabbedPane_left_tab_selectedImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_left_tab_selectedImage:Class;
		
		[Embed(source="assets/TabbedPane_left_tab_rolloverSelectedImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_left_tab_rolloverSelectedImage:Class;
		
		//========= header right scale-9 =======
		[Embed(source="assets/TabbedPane_right_tab_defaultImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_right_tab_defaultImage:Class;
		
		[Embed(source="assets/TabbedPane_right_tab_pressedImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_right_tab_pressedImage:Class;
		
		[Embed(source="assets/TabbedPane_right_tab_rolloverImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_right_tab_rolloverImage:Class;
		
		[Embed(source="assets/TabbedPane_right_tab_disabledImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_right_tab_disabledImage:Class;
		
		[Embed(source="assets/TabbedPane_right_tab_selectedImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		private var TabbedPane_right_tab_selectedImage:Class;
		
		[Embed(source="assets/TabbedPane_right_tab_rolloverSelectedImage.png", scaleGridTop="5", scaleGridBottom="12", scaleGridLeft="5", scaleGridRight="18")]
		...
		[Embed(source="assets/TableHeader_cell_defaultImage.png", scaleGridTop="3", scaleGridBottom="14", scaleGridLeft="7", scaleGridRight="15")]
		private var TableHeader_cell_defaultImage:Class;
		
		[Embed(source="assets/TableHeader_cell_pressedImage.png", scaleGridTop="3", scaleGridBottom="14", scaleGridLeft="7", scaleGridRight="15")]
		private var TableHeader_cell_pressedImage:Class;
		
		[Embed(source="assets/TableHeader_cell_disabledImage.png", scaleGridTop="3", scaleGridBottom="14", scaleGridLeft="7", scaleGridRight="15")]
		private var TableHeader_cell_disabledImage:Class;
		
		[Embed(source="assets/TableHeader_cell_rolloverImage.png", scaleGridTop="3", scaleGridBottom="14", scaleGridLeft="7", scaleGridRight="15")]
		...
		//[Embed(source="assets/MenuBar_bgImage.png" , scaleGridTop="4", scaleGridBottom="20", scaleGridLeft="5", scaleGridRight="13")]
	...
	override protected function initComponentDefaults(table:UIDefaults):void{
		...
		var comDefaults:Array = [
			...
			"Button.background", new ASColorUIResource(0xe1e5e5), //this is just for calculate disabled color
			"Button.foreground", new ASColorUIResource(0x5d5d5d),  
			"Button.opaque", false, 
		...
		comDefaults = [
			...
			"Frame.border", new SkinEmptyBorder(0, 8, 8, 8), //modify this to fit the frame bg image
            ...
            "Frame.icon.defaultImage", Frame_Icon_defaultImage,
		...
		comDefaults = [
			...
			"FrameTitleBar.icon", Frame_Icon_defaultImage, 
			...
			"FrameTitleBar.iconifiedIcon.defaultImage", Frame_iconifiedIcon_defaultImage, 
			"FrameTitleBar.iconifiedIcon.pressedImage", Frame_iconifiedIcon_pressedImage, 
			"FrameTitleBar.iconifiedIcon.disabledImage", Frame_iconifiedIcon_disabledImage, 
			"FrameTitleBar.iconifiedIcon.rolloverImage", Frame_iconifiedIcon_rolloverImage, 
			
			"FrameTitleBar.normalIcon.defaultImage", Frame_normalIcon_defaultImage, 
			"FrameTitleBar.normalIcon.pressedImage", Frame_normalIcon_pressedImage, 
			"FrameTitleBar.normalIcon.disabledImage", Frame_normalIcon_disabledImage, 
			"FrameTitleBar.normalIcon.rolloverImage", Frame_normalIcon_rolloverImage, 
			
			"FrameTitleBar.maximizeIcon.defaultImage", Frame_maximizeIcon_defaultImage, 
			"FrameTitleBar.maximizeIcon.pressedImage", Frame_maximizeIcon_pressedImage, 
			"FrameTitleBar.maximizeIcon.disabledImage", Frame_maximizeIcon_disabledImage, 
			"FrameTitleBar.maximizeIcon.rolloverImage", Frame_maximizeIcon_rolloverImage,
			
			"FrameTitleBar.closeIcon.defaultImage", Frame_closeIcon_defaultImage, 
			"FrameTitleBar.closeIcon.pressedImage", Frame_closeIcon_pressedImage, 
			"FrameTitleBar.closeIcon.disabledImage", Frame_closeIcon_disabledImage, 
			"FrameTitleBar.closeIcon.rolloverImage", Frame_closeIcon_rolloverImage
		];
		table.putDefaults(comDefaults);
		// *** ToolTip
		comDefaults = [
		...
		// *** Accordion
		comDefaults = [
			"Accordion.background", new ASColorUIResource(0xe5e5e5), //this is just for calculate disabled color
			"Accordion.foreground", new ASColorUIResource(0x4d4d4d), 
		...
		// *** Adjuster
		comDefaults = [
			"Adjuster.bg", SkinTextFieldBackground, 
